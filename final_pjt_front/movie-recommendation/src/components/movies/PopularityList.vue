  ...
  <div class="popularity-list">
    ...
    <div class="slider-container" @mouseover="showButtons" @mouseleave="hideButtons">
      ...
      <div class="movies-container" ref="slider">
        <PopularityListItem
          v-for="p_movie in movieStore.popularityMovies"
          :key="p_movie.id"
          :p_movie="p_movie"
          class="movie-item"
        />
...
import PopularityListItem from '@/components/movies/PopularityListItem.vue'
...
onMounted(() => {
  movieStore.fetchPopularityMovies()
})
</script>
