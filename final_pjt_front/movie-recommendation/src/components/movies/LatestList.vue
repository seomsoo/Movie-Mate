  ...
  <div class="latest-movies">
    ...
    <div class="slider-container" @mouseover="showButtons" @mouseleave="hideButtons">
      ...
      <div class="movies-container" ref="slider">
        <LatestListItem 
          v-for="(movie, index) in movieStore.nowRunningMovies"
          :key="movie.id"
          :movie="movie"
          class="movie-item"
        />
...
import LatestListItem from '@/components/movies/LatestListItem.vue'
...
onMounted(() => {
  movieStore.fetchNowRunningMovies()
})
</script>
